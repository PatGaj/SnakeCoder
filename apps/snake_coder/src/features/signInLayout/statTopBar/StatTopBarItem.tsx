...
const StatTopBarItem: React.FC<StatTopBarItemProps> = ({
  ...
  return (
    <Tooltip content={tooltip} side="bottom" variant="muted">
      <span
        className={clsx(
          'inline-flex items-center gap-3 rounded-2xl border px-3 py-2 text-snowWhite-50 shadow-[0_18px_48px_#0000005c]',
          className
        )}
      >

...
const CtaSection = () => {
  ...
  return (
    <section id="start" className="scroll-mt-28">
      <Box variant="glass" size="md" round="3xl" className="relative w-full overflow-hidden border-primary-800/70">
        ...
        <div className="relative grid gap-6 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
          <div className="space-y-4">
            ...
            <h3 className="text-2xl text-center lg:text-start font-semibold text-snowWhite-50 md:text-3xl">{t('cta.title')}</h3>
            <p className="text-sm text-center lg:text-start text-snowWhite-300 md:text-base">{t('cta.subtitle')}</p>
          </div>
